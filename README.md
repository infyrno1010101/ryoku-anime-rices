...
|---|---|---|
| **Jujutsu Kaisen — Season 3: Culling Game Overdrive**<br><code>jujutsu-kaisen-season-3-culling-game-overdrive</code> | ![Animated preview for Jujutsu Kaisen — Season 3: Culling Game Overdrive](previews/jujutsu-kaisen-season-3-culling-game-overdrive.gif) | Culling Game ensemble with chromatic glitches, moving barrier bands, and cursed-energy pressure. **Bar:** top islands. **Keys:** crystal-purple. |
| **Frieren Season 2 — Aureole Reverie**<br><code>frieren-season-2-aureole-reverie</code> | ![Animated preview for Frieren Season 2 — Aureole Reverie](previews/frieren-season-2-aureole-reverie.gif) | A serene ultra-wide journey pan with drifting light and a quiet blue-gold atmosphere. **Bar:** bottom notch. **Keys:** creamy. |
| **Witch Hat Atelier — Silver Ink Coven**<br><code>witch-hat-atelier-silver-ink-coven</code> | ![Animated preview for Witch Hat Atelier — Silver Ink Coven](previews/witch-hat-atelier-silver-ink-coven.gif) | Portrait parchment composition animated with rotating drafting circles and living silver ink. **Bar:** top fit. **Keys:** topre. |
| **Bleach: Thousand-Year Blood War — Blood War Zenith**<br><code>bleach-tybw-blood-war-zenith</code> | ![Animated preview for Bleach: Thousand-Year Blood War — Blood War Zenith](previews/bleach-tybw-blood-war-zenith.gif) | Stark monochrome Soul Reaper poster cut by moving red blades and inversion flashes. **Bar:** top full. **Keys:** cherry-mx-blue. |
| **Mushoku Tensei — Mana Labyrinth**<br><code>mushoku-tensei-mana-labyrinth</code> | ![Animated preview for Mushoku Tensei — Mana Labyrinth](previews/mushoku-tensei-mana-labyrinth.gif) | Cinematic interior parallax with expanding cyan-jade mana rings. **Bar:** bottom islands. **Keys:** creamy. |
| **Goodbye, Lara — Abyssal Farewell**<br><code>goodbye-lara-abyssal-farewell</code> | ![Animated preview for Goodbye, Lara — Abyssal Farewell](previews/goodbye-lara-abyssal-farewell.gif) | Lake and mermaid imagery animated through water-refraction strips and rising bubbles. **Bar:** top notch. **Keys:** creamy. |
| **You and I Are Polar Opposites — Season 2: Chromatic Polarity**<br><code>polar-opposites-season-2-chromatic-polarity</code> | ![Animated preview for You and I Are Polar Opposites — Season 2: Chromatic Polarity](previews/polar-opposites-season-2-chromatic-polarity.gif) | A playful manga-cover split screen moving in opposing pink and cyan directions. **Bar:** top islands. **Keys:** holy-panda. |
| **Ghost in the Shell — Cyberbrain Rain**<br><code>ghost-in-the-shell-cyberbrain-rain</code> | ![Animated preview for Ghost in the Shell — Cyberbrain Rain](previews/ghost-in-the-shell-cyberbrain-rain.gif) | Cyber portrait with scanlines, block glitches, and falling neural data. **Bar:** bottom full. **Keys:** tealios. |
| **Daemons of the Shadow Realm — Gate of Night**<br><code>daemons-shadow-realm-gate-of-night</code> | ![Animated preview for Daemons of the Shadow Realm — Gate of Night](previews/daemons-shadow-realm-gate-of-night.gif) | The official key visual becomes two opposed moving gates divided by a gold seam. **Bar:** top fit. **Keys:** topre. |
| **JoJo’s Bizarre Adventure: Steel Ball Run — Golden Spin**<br><code>jojo-steel-ball-run-golden-spin</code> | ![Animated preview for JoJo’s Bizarre Adventure: Steel Ball Run — Golden Spin](previews/jojo-steel-ball-run-golden-spin.gif) | Johnny, Gyro, and Lucy framed by an animated golden-ratio spiral. **Bar:** top islands. **Keys:** cherry-mx-blue. |
| **Hell’s Paradise — Season 2: Tao Inferno**<br><code>hells-paradise-season-2-tao-inferno</code> | ![Animated preview for Hell’s Paradise — Season 2: Tao Inferno](previews/hells-paradise-season-2-tao-inferno.gif) | Shinsenkyo artwork transformed into a living red-and-jade floral kaleidoscope. **Bar:** bottom full. **Keys:** holy-panda. |
| **Dorohedoro — Season 2: Hole Smoke Ritual**<br><code>dorohedoro-season-2-hole-smoke-ritual</code> | ![Animated preview for Dorohedoro — Season 2: Hole Smoke Ritual](previews/dorohedoro-season-2-hole-smoke-ritual.gif) | A gritty character scene distorted by drifting smoke and chromatic corruption. **Bar:** top fit. **Keys:** cherry-mx-brown. |
